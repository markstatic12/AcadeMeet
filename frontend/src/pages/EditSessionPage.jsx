...
import { DetailsPanel, DescriptionPanel } from '../components/sessions/SessionForm';
...
const EditSessionPage = () => {
  ...
  } = useEditSessionForm(sessionId, showToast);
      ...
      <div className="h-screen bg-gradient-to-br from-[#0a0a14] via-[#0f0f1e] to-[#1a1a2e] relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-white text-lg">Loading session data...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="h-screen bg-gradient-to-br from-[#0a0a14] via-[#0f0f1e] to-[#1a1a2e] relative overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col max-w-[1600px] mx-auto w-full px-8 py-5 animate-fadeIn">
        <form onSubmit={handleSubmit} className="h-full flex flex-col">
          {/* Header with Back Button and Floating Update Button */}
          ...
          <div className="flex-1 relative overflow-hidden">
            <div className="relative h-full flex flex-col">
              ...
              <div className="flex items-center gap-4 p-6 pb-5 border-b border-indigo-900/20 flex-shrink-0">
                <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center overflow-hidden shadow-lg">
