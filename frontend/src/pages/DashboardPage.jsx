...
const DashboardPage = () => {
  ...
  // notes loaded from backend for the current user
              ...
              <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-4 space-y-3">
                ...
                {!notesLoading && notes.length === 0 && (
                  <div className="text-center py-4">
                    ...
                    <Link to="/create-note" className="inline-block px-4 py-2 bg-indigo-600 text-white rounded-full text-sm hover:bg-indigo-500">Create a note</Link>
                  </div>
                )}
