    ...
    <div className="relative bg-[#161A2B] border border-indigo-900/40 rounded-2xl overflow-hidden shadow-2xl shadow-indigo-950/30 transition-all hover:shadow-indigo-500/40 hover:border-indigo-500/60 group/profilecard h-full flex flex-col sticky top-4">
      ...
      <div className="relative h-32 overflow-visible flex-shrink-0">
        ...
        <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2">
          <div className="relative">
            ...
            {userData.isOnline && (
              <div className="absolute bottom-0.5 right-0.5 w-4 h-4 bg-green-500 rounded-full border-3 border-[#161A2B] shadow-lg shadow-green-500/50">
      ...
      <div className="pt-14 px-5 pb-5 flex flex-col flex-1">
        ...
        <div className="text-center mb-4 flex-shrink-0">
          <h2 className="text-xl font-bold text-white mb-1.5 tracking-tight group-hover/profilecard:text-indigo-400 transition-all duration-300">
            {userData.name}
          </h2>
          ...
          {/* Mentor Badge */}
          {userData.isMentor && (
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-500/10 border border-amber-500/30 rounded-full text-xs text-amber-300 mt-2">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* Additional Stats for Mentors */}
        {userData.isMentor && (
          <div className="grid grid-cols-2 gap-3 mb-4 flex-shrink-0 animate-slideUp" style={{ animationDelay: '0.2s' }}>
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 border border-gray-700/50 rounded-xl p-2.5 text-center transition-all hover:border-indigo-500/30 hover:bg-gray-800/70">
              <div className="flex items-center justify-center gap-1 mb-1">
                <svg className="w-3.5 h-3.5 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <p className="text-xs font-bold text-white">{userData.rating || 0}</p>
              </div>
              <p className="text-[10px] text-gray-400 font-medium">{userData.totalReviews || 0} Reviews</p>
            </div>
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-800/30 border border-gray-700/50 rounded-xl p-2.5 text-center transition-all hover:border-indigo-500/30 hover:bg-gray-800/70">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <p className="text-xs font-bold text-white">{userData.completedSessions || 0}</p>
              </div>
        ...
        <div className="space-y-2.5 animate-slideUp flex-shrink-0" style={{ animationDelay: '0.25s' }}>
          {/* Primary Action: Follow Button */}
          <button
            onClick={onFollow}
            className={`w-full relative overflow-hidden text-sm font-bold py-3 px-3 rounded-xl transition-all shadow-lg group/btn ${
              isFollowing
          ...
          <div className="flex gap-2.5">
            ...
            <button
              onClick={onMessage}
              className="flex-1 relative overflow-hidden bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 text-gray-300 hover:text-white text-sm font-bold py-2.5 px-3 rounded-xl transition-all border border-gray-700 hover:border-indigo-500/50 hover:scale-105 group/btn shadow-lg"
            >
            ...
            {userData.isMentor && (
              <button
                ...
                className="flex-1 relative overflow-hidden bg-gradient-to-r from-amber-600/20 to-amber-700/20 hover:from-amber-600/30 hover:to-amber-700/30 text-amber-300 hover:text-amber-200 text-sm font-bold py-2.5 px-3 rounded-xl transition-all border border-amber-500/30 hover:border-amber-500/50 hover:scale-105 group/btn shadow-lg"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent translate-x-[-200%] group-hover/btn:translate-x-[200%] transition-transform duration-700"></div>
                <span className="relative z-10 flex items-center justify-center gap-2">
                  <svg className="w-4 h-4 group-hover/btn:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
