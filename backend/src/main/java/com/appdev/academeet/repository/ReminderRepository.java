...
public interface ReminderRepository extends JpaRepository<Reminder, Long> {
    ...
    @Query("SELECT r FROM Reminder r WHERE r.user.id = :userId AND r.isRead = false ORDER BY r.reminderTime ASC")
    ...
    @Modifying
    @Query("UPDATE Reminder r SET r.isSent = true, r.sentAt = :sentTime WHERE r.id = :reminderId")
